...
\$$ (BarWidth + BarSpace) * #datasets + groupSpace = 1 $$
...
\$$ BarWidth + BarSpace = (1 - groupSpace)/#datasets $$
...
\$$ 0.9x + 0.1x = (1 - groupSpace)/#datasets $$
...
\$$ maxXValue = START_X_VALUE + groupWidth(GROUP_SPACE, barSpace) * maxEntries $$
